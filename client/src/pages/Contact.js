      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="mb-4">
          <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
            ...
            <h2 className="font-heading mb-4 font-bold tracking-tight text-blue-950  text-3xl sm:text-5xl">
              Orange Garments
            </h2>
            <p className="mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-slate-400">
              Your style is our responsibility
            </p>
          </div>
        </div>
        <div className="flex items-stretch justify-center">
          <div className="grid md:grid-cols-2">
              ...
              <ul className="mb-6 md:mb-0">
                <li className="flex">
                  ...
                  <div className="ml-4 mb-4">
                    <h3 className="mb-2 text-lg font-medium leading-6 text-blue-950 ">Our Address</h3>
                    <p className="text-gray-600 dark:text-slate-400">Orange Garments
                    41-N-A,Marakkal Kadu,New Pallipalayam Road,Komarapalayam,Namakkal, Komarapalayam-638183, Tamil Nadu, India</p>
                  </div>
                </li>
                <li className="flex">
                  <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                  ...
                  <div className="ml-4 mb-4">
                    <h3 className="mb-2 text-lg font-medium leading-6 text-blue-950">Contact</h3>
                    <p className="text-gray-600 dark:text-slate-400">Mobile: +91 7598287008</p>
                    <p className="text-gray-600 dark:text-slate-400">Mail: OrangeGarments@gmail.com</p>
                  </div>
                </li>
                <li className="flex">
                  <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                  ...
                  <div className="ml-4 mb-4">
                    <h3 className="mb-2 text-lg font-medium leading-6 text-blue-950">Working hours</h3>
            ...
            <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
              <h2 className="mb-4 text-2xl font-bold text-blue-950">Ready to Get Started?</h2>
              <form id="contactForm">
                <div className="mb-6">
